...
if (!is_user_logged_in()) {
    echo "<p>Please login to view your Events.</p>";
    return;
}
...
<div class='filters-row' style='display:flex;gap:10px;align-items:center;'>
        ...
        <div class="multi-select-dropdown">
            ...
            <div class="dropdown-content">
                <?php
                $terms = get_terms(['taxonomy'=>'event-category','hide_empty'=>false]);
        ...
        <a href="<?php echo $siteurl; ?>/dashboard/events/" class="btn reset">Reset</a>
    </div>
</form>
    ...
    if (isset($_GET['msg'])) {
        ...
        echo ($_GET['msg']=='added') ? 'Event Added Successfully (Pending Review)' : 'Event Updated Successfully';
		echo ($_GET['msg']=='added_admin') ? 'Event Added Successfully.' : 'Event Updated Successfully';
        echo '</div>';
    }
	...
	<?php if (isset($_GET['updated'])): ?>
		<div class="notice success">Events updated successfully.</div>
	<?php endif; ?>
    ...
    <table style="width:100%;border-collapse:collapse;margin-top:20px;">
        ...
        <?php if ($ads->have_posts()) : while ($ads->have_posts()) : $ads->the_post(); 
            ...
            $cats = wp_get_post_terms($post_id, 'event-category', ['fields'=>'names']);
        ...
        ?>
            ...
            <tr>
                ...
                <td style="padding:10px;border:1px solid #ddd;"><?php echo $event_type; ?></td>
