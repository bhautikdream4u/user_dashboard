...
<h2>
<?php echo $is_admin
    ? 'Listing Updated – Review Required'
    : 'Your Listing Update Is Under Review'; ?>
</h2>

<?php if (!$is_admin): ?>
<p>You have updated your business listing.  
Our team is reviewing your changes. Once approved, the listing will be visible again.</p>
<?php else: ?>
<p>A user has updated their business listing. Please review the changes.</p>
<?php endif; ?>
